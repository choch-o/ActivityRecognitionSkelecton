...
public class Constants {
	// Parameters
	public final static String[] CLASS_LABELS = {"still", "walk", "run", "bike"}; // Should be predefined before collecting data
	public final static String[] ARFF_FILE_NAMES = {"still.txt", "walk.txt", "run.txt", "bike.txt"}; // Will be used for model building after merging
